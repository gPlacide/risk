...
#board0 = Board([Territory(territory_id=i, player_id=1, armies=i%5+1) for i in range(42)])board0 = Board([Territory(territory_id=i, player_id=1, armies=i%5+1) for i in range(42)])board1.plot_board(path=path)
